...
class ForgetPassCreateNewPasswordScreen extends StatefulWidget {
  static const routeName = '/ForgetPassCreateNewPasswordScreen';

  const ForgetPassCreateNewPasswordScreen({super.key});

  @override
  State<ForgetPassCreateNewPasswordScreen> createState() => _ForgetPassCreateNewPasswordScreenState();
}

class _ForgetPassCreateNewPasswordScreenState extends State<ForgetPassCreateNewPasswordScreen> with TickerProviderStateMixin, RouteAware {
            ...
            children: [
              ...
              SlideTransition(
                ...
                child: MaterialButtonWidget(
                  onPressed: () {
                    context.pushNamed(CongratsScreen.routeName);
                  },
